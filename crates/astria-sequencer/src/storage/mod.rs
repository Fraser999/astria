...
// }
//
// /// Provides a `String` version of the given key for display (logging) purposes, parsed from
// UTF-8 /// if possible, falling back to base64 encoding.
// pub(crate) fn display_nonverifiable_key(key: &[u8]) -> String {
//     String::from_utf8(key.to_vec()).unwrap_or_else(|_|
// telemetry::display::base64(key).to_string()) }
