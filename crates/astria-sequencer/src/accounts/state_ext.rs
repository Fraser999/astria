...
pub(crate) trait StateReadExt: StateRead + crate::assets::StateReadExt {
    ...
    async fn get_account_balances(
        ...
        while let Some(Ok(key)) = stream.next().await {
            ...
            let native_asset = self.get_native_asset(immutable_data);
    ...
    #[instrument(skip_all)]
    fn get_transfer_base_fee(&self, immutable_data: &ImmutableData) -> u128 {
        immutable_data.fees.transfer_base_fee
        // let bytes = self
