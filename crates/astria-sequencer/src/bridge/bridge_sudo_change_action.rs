...
impl ActionHandler for BridgeSudoChangeAction {
    ...
    async fn check_and_execute<S: StateWrite>(
        ...
        let fee = state.get_bridge_sudo_change_base_fee(immutable_data);
        state
