...
/// error response.
// NOTE: This functionality can be removed once Upgrade1 has been deployed, as all future networks
//       will store the consensus params in storage during `init_chain`, and existing networks
//       store it while executing Upgrade1.
