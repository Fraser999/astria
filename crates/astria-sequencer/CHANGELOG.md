...
- Changed `CurrencyPairsChange::Addition` action to fail if any currency pair to
  be added is already stored [#2222](https://github.com/astriaorg/astria/pull/2222).
- Changed `CurrencyPairsChange::Removal` action to fail if any currency pair to
  be removed is not currently stored [#2222](https://github.com/astriaorg/astria/pull/2222).
- Changed `FeeAssetChange::Addition` action to fail if the fee asset to be added
  is already stored [#2222](https://github.com/astriaorg/astria/pull/2222).
- Changed `FeeAssetChange::Removal` action to fail if the fee asset to be
  removed is not currently stored [#2222](https://github.com/astriaorg/astria/pull/2222).
...
- Changed `MarketsChange::Removal` action to fail if any market to be removed is
  not currently stored [#2222](https://github.com/astriaorg/astria/pull/2222).
