...
docker buildx build --load --build-arg TARGETBINARY=astria-bridge-withdrawer \
    -f containerfiles/Dockerfile \
    -t ghcr.io/astriaorg/evm-bridge-withdrawer:local .
kind load docker-image ghcr.io/astriaorg/evm-bridge-withdrawer:local \
