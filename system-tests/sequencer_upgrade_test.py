...
print(f"passed pre-upgrade checks specific to {upgrade_name}")
...
new_node.wait_until_chain_at_height(upgrade_activation_height + 2, timeout_secs=60)
...
print(f"passed post-upgrade checks specific to {upgrade_name}")
