...
class SequencerController:
    ...
    def _helm_args(
        ...
        if enable_persistent_storage:
            ...
            args.append(f"--set=sequencer-relayer.storage.enabled=true")
        # If this is an upgrade test, set `genesis.postLatestUpgrade` to false so as to provide
        # an upgrades.json file.
        if upgrade_name:
